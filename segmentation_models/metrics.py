...
class IOUScore(Metric):
    ...
    def __call__(self, gt, pr):
        # print("Within the metrics.py")
        # print("type(gt): ", type(gt))
        # print("gt.shape: ", gt.shape)

        # print("type(pr): ", type(pr))
...
class clDice(Metric):
    r"""centerline-in-mask-dice-coefficient or clDice
    ...
    Returns:
        A callable ``clDice`` instance. Can be used in ``model.compile(...)`` function.
