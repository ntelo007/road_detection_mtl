...
class soft_clDiceLoss(Loss):
    """Creates a criterion that measures the soft clDice loss 
    Example:

    .. code:: python

        loss = soft_clDiceLoss()
        model.compile('SGD', loss=loss)
    """
...
dice_loss = DiceLoss()
soft_cldice_loss = soft_clDiceLoss()
