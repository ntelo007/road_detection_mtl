...
from .models.MultiTaskLearningUNet import Unet_MTL
from .models.UNet_MTL_Late_split import Unet_Late_MTL
from .models.MTL_pspnet import MTL_pspnet
...
Unet_MTL = inject_global_submodules(Unet_MTL)
MTL_pspnet = inject_global_submodules(MTL_pspnet)
Unet_Late_MTL = inject_global_submodules(Unet_Late_MTL)
...
__all__ = [
    ...
    '__version__', 'Unet_MTL', 'Unet_Late_MTL', 'MTL_pspnet'
]
